...
Scenario: [29] Verify user can remove vehicle from garage via Wishlist Screen - one item in garage
  ...
  Scenario: [33] Verify Sorting options are displayed in Series View
    Given No cars should be added to the Vehicles tab
    When I tap Search from the Navigation Menu at the bottom
    When I input the "AUDI R8 LMS" into the search textbox,
    Then I should see the "AUDI R8 LMS" car on the screen.
    ...
    When I'm in the Series tab
    Then I see the filter icon
    And I see the "Recently Collected" sorting option
    And I see the "Year" sorting option
  ...
  Scenario: [34] Verify user is able to filter vehicles  - Vehicle view
    Given No cars should be added to the Vehicles tab
    When I tap Search from the Navigation Menu at the bottom
    When I input the "AUDI R8 LMS" into the search textbox,
    Then I should see the "AUDI R8 LMS" car on the screen.
  ...
  Scenario: [35] Verify user is able to filter vehicles  - Vehicle view
    Given No cars should be added to the Vehicles tab
    When I tap Search from the Navigation Menu at the bottom
    When I input the "AUDI R8 LMS" into the search textbox,
    Then I should see the "AUDI R8 LMS" car on the screen.
  ...
  Scenario: [36] Verify user is able to filter vehicles  - Vehicle view
    Given No cars should be added to the Vehicles tab
    When I tap Search from the Navigation Menu at the bottom
    When I input the "AUDI R8 LMS" into the search textbox,
    Then I should see the "AUDI R8 LMS" car on the screen.
  ...
  Scenario: [37] Verify user is able to filter vehicles  - Vehicle view
    Given No cars should be added to the Vehicles tab
    When I tap Search from the Navigation Menu at the bottom
    When I input the "AUDI R8 LMS" into the search textbox,
    Then I should see the "AUDI R8 LMS" car on the screen.
  ...
  Scenario: [38] Verify user is able to filter vehicles  - Vehicle view
    Given No cars should be added to the Vehicles tab
    When I tap Search from the Navigation Menu at the bottom
    When I input the "AUDI R8 LMS" into the search textbox,
    Then I should see the "AUDI R8 LMS" car on the screen.
  ...
  Scenario: [39] Verify user is able to filter vehicles  - Vehicle view
    Given No cars should be added to the Vehicles tab
    When I tap Search from the Navigation Menu at the bottom
    When I input the "AUDI R8 LMS" into the search textbox,
    Then I should see the "AUDI R8 LMS" car on the screen.
  ...
  Scenario: [40] Verify user is able to filter vehicles  - Vehicle view
    Given No cars should be added to the Vehicles tab
    When I tap Search from the Navigation Menu at the bottom
    When I input the "AUDI R8 LMS" into the search textbox,
    Then I should see the "AUDI R8 LMS" car on the screen.
  ...
  Scenario: [41] Verify user is able to filter vehicles  - Vehicle view
    Given No cars should be added to the Vehicles tab
    When I tap Search from the Navigation Menu at the bottom
    When I input the "AUDI R8 LMS" into the search textbox,
    Then I should see the "AUDI R8 LMS" car on the screen.
  ...
  Scenario: [42] Verify user is able to filter vehicles  - Vehicle view
  ...
  Scenario: [43] Verify user is able to filter vehicles  - Vehicle view
  ...
  Scenario: [44] Verify user is able to filter vehicles - Wishlisht View
    Given No vehicle are present in Wishlist
    When I tap Search from the Navigation Menu at the bottom
    When I input the "AUDI R8 LMS" into the search textbox,
    Then I should see the "AUDI R8 LMS" car on the screen.
