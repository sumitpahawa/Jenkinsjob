...
##And I am in My Collection Screen
##And I tap in the wishlist tab
##And I see a list of Vehicles Cards
##And I see the vehicle card for the vehicle I have in my collection
##When I tap in the plus icon of one vehicle card"
##And I should see the number of vehicles in my collection increased by 1, indicating that the selected vehicle has been successfully added
#
#  Compose: